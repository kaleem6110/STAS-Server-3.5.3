...
import lu.hitec.pss.soap.sensor.client._12_x.DeviceLocationsForMission;
import lu.hitec.pss.soap.sensor.client._12_x.DeviceMission;
import lu.hitec.pss.soap.sensor.client._12_x.DeviceMissionWrapper;
import lu.hitec.pss.soap.sensor.client._12_x.DeviceTypeMission;
...
import lu.hitec.pss.soap.sensor.client._12_x.SensorSrvClient_Service;
...
import lu.hitec.pss.soap.sensor.client._12_x.TimeRange;
...
public class SensorServiceUtils implements IEPICConstants {
					...
					if(unitReports!=null)
					{
						...
						if(userReports!=null)
						{
							...
							{  
								LocationRange locationRange = stub.getUnitLocationRange(token, 
										new UnitId( userReport.getUnitId(), UnitType.fromValue( UnitType._USER) ),mission, rl);						
								setAllEmergencyHotspots(  token, userReport.getUnitId() ,
						...
						if(vehicleReports!=null)
						{
							for(UnitReport vehicleReport: vehicleReports)
							{
								...
								if(vehicleReport.getUnitId().length()==6)
									 setAllEmergencyHotspots(  token, vehicleReport.getUnitId() , 
											 locationRange, allAirplaneDevices , UnitType._VEHICLE );
								else setAllEmergencyHotspots(   token, vehicleReport.getUnitId() ,
	...
	private static void setAllEmergencyHotspots(String token, String unitId,
	...
	public static SensorSrvClientPortBindingStub getServiceLocatorStub() {
		...
		try {
			sensorSrvClientPortBindingStub = new SensorSrvClientPortBindingStub(
					new java.net.URL(
							WFPConfigUtils.getWFPConfigValue("soapgps") == null ? "http://middleware.service.emergency.lu/sensorservice/out/soap/SensorSrvClient"
									: WFPConfigUtils
