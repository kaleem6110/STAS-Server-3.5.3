...
public class SubRangeDetails  implements java.io.Serializable {
    ...
    private lu.hitec.pss.soap.sensor.client._12_x.SubRangeType subRangeType;  // attribute
    ...
    public SubRangeDetails(
           int missingValues,
           lu.hitec.pss.soap.sensor.client._12_x.SubRangeType subRangeType) {
     ...
     * @return subRangeType
     */
    public lu.hitec.pss.soap.sensor.client._12_x.SubRangeType getSubRangeType() {
        return subRangeType;
    }
     ...
     * @param subRangeType
     */
    public void setSubRangeType(lu.hitec.pss.soap.sensor.client._12_x.SubRangeType subRangeType) {
        this.subRangeType = subRangeType;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/sensor/client/12.x", "subRangeDetails"));
