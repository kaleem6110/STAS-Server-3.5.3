...
public class UnitSummary  implements java.io.Serializable {
    private lu.hitec.pss.soap.sensor.client._12_x.LocationSummary loc;

    private java.lang.String missionId;

    private lu.hitec.pss.soap.sensor.client._12_x.ProbeSummary[] probes;
    ...
    public UnitSummary(
           lu.hitec.pss.soap.sensor.client._12_x.LocationSummary loc,
           java.lang.String missionId,
           lu.hitec.pss.soap.sensor.client._12_x.ProbeSummary[] probes,
           java.lang.String id,
     ...
     * @return loc
     */
    public lu.hitec.pss.soap.sensor.client._12_x.LocationSummary getLoc() {
        return loc;
    }
     ...
     * @param loc
     */
    public void setLoc(lu.hitec.pss.soap.sensor.client._12_x.LocationSummary loc) {
        this.loc = loc;
    }
     ...
     * @return probes
     */
    public lu.hitec.pss.soap.sensor.client._12_x.ProbeSummary[] getProbes() {
        return probes;
    }
     ...
     * @param probes
     */
    public void setProbes(lu.hitec.pss.soap.sensor.client._12_x.ProbeSummary[] probes) {
        this.probes = probes;
    }

    public lu.hitec.pss.soap.sensor.client._12_x.ProbeSummary getProbes(int i) {
        return this.probes[i];
    }

    public void setProbes(int i, lu.hitec.pss.soap.sensor.client._12_x.ProbeSummary _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/sensor/client/12.x", "unitSummary"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/sensor/client/12.x", "locationSummary"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/sensor/client/12.x", "probeSummary"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
