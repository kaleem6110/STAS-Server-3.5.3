...
public class ProbeValue  implements java.io.Serializable {
    private lu.hitec.pss.soap.sensor.client._9_x.ProbeStatus status;
    ...
    public ProbeValue(
           lu.hitec.pss.soap.sensor.client._9_x.ProbeStatus status,
     ...
     * @return status
     */
    public lu.hitec.pss.soap.sensor.client._9_x.ProbeStatus getStatus() {
        return status;
    }
     ...
     * @param status
     */
    public void setStatus(lu.hitec.pss.soap.sensor.client._9_x.ProbeStatus status) {
        this.status = status;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/sensor/client/9.x", "probeValue"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/sensor/client/9.x", "probeStatus"));
