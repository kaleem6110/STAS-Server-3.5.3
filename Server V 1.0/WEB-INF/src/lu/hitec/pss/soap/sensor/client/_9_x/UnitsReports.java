...
public class UnitsReports  implements java.io.Serializable {
    private lu.hitec.pss.soap.sensor.client._9_x.UnitReport[] placesReports;

    private lu.hitec.pss.soap.sensor.client._9_x.UnitReport[] usersReports;

    private lu.hitec.pss.soap.sensor.client._9_x.UnitReport[] vehiclesReports;

    public UnitsReports() {
    }

    public UnitsReports(
           lu.hitec.pss.soap.sensor.client._9_x.UnitReport[] placesReports,
           lu.hitec.pss.soap.sensor.client._9_x.UnitReport[] usersReports,
           lu.hitec.pss.soap.sensor.client._9_x.UnitReport[] vehiclesReports) {
     ...
     */
    public lu.hitec.pss.soap.sensor.client._9_x.UnitReport[] getPlacesReports() {
        return placesReports;
    }
     ...
     * @param placesReports
     */
    public void setPlacesReports(lu.hitec.pss.soap.sensor.client._9_x.UnitReport[] placesReports) {
        this.placesReports = placesReports;
    }

    public lu.hitec.pss.soap.sensor.client._9_x.UnitReport getPlacesReports(int i) {
        return this.placesReports[i];
    }

    public void setPlacesReports(int i, lu.hitec.pss.soap.sensor.client._9_x.UnitReport _value) {
     ...
     * @return usersReports
     */
    public lu.hitec.pss.soap.sensor.client._9_x.UnitReport[] getUsersReports() {
        return usersReports;
    }
     ...
     * @param usersReports
     */
    public void setUsersReports(lu.hitec.pss.soap.sensor.client._9_x.UnitReport[] usersReports) {
        this.usersReports = usersReports;
    }

    public lu.hitec.pss.soap.sensor.client._9_x.UnitReport getUsersReports(int i) {
        return this.usersReports[i];
    }

    public void setUsersReports(int i, lu.hitec.pss.soap.sensor.client._9_x.UnitReport _value) {
     ...
     */
    public lu.hitec.pss.soap.sensor.client._9_x.UnitReport[] getVehiclesReports() {
        return vehiclesReports;
    }
     ...
     */
    public void setVehiclesReports(lu.hitec.pss.soap.sensor.client._9_x.UnitReport[] vehiclesReports) {
        this.vehiclesReports = vehiclesReports;
    }

    public lu.hitec.pss.soap.sensor.client._9_x.UnitReport getVehiclesReports(int i) {
        return this.vehiclesReports[i];
    }

    public void setVehiclesReports(int i, lu.hitec.pss.soap.sensor.client._9_x.UnitReport _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/sensor/client/9.x", "unitsReports"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("placesReports");
        elemField.setXmlName(new javax.xml.namespace.QName("", "placesReports"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/sensor/client/9.x", "unitReport"));
