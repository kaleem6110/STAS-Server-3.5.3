...
public class ProbeSummary  implements java.io.Serializable {
    private lu.hitec.pss.soap.sensor.client._11_x.ProbeValue latest;
    ...
    public ProbeSummary(
           lu.hitec.pss.soap.sensor.client._11_x.ProbeValue latest,
     ...
     * @return latest
     */
    public lu.hitec.pss.soap.sensor.client._11_x.ProbeValue getLatest() {
        return latest;
    }
     ...
     * @param latest
     */
    public void setLatest(lu.hitec.pss.soap.sensor.client._11_x.ProbeValue latest) {
        this.latest = latest;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/sensor/client/11.x", "probeSummary"));
