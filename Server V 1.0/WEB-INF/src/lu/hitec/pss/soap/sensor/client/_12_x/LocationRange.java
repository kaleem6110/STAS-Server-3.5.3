...
public class LocationRange  implements java.io.Serializable {
    ...
    private lu.hitec.pss.soap.sensor.client._12_x.LocationValue[] val;
    ...
    public LocationRange(
           ...
           lu.hitec.pss.soap.sensor.client._12_x.LocationValue[] val) {
     ...
     * @return val
     */
    public lu.hitec.pss.soap.sensor.client._12_x.LocationValue[] getVal() {
        return val;
    }
     ...
     * @param val
     */
    public void setVal(lu.hitec.pss.soap.sensor.client._12_x.LocationValue[] val) {
        this.val = val;
    }

    public lu.hitec.pss.soap.sensor.client._12_x.LocationValue getVal(int i) {
        return this.val[i];
    }

    public void setVal(int i, lu.hitec.pss.soap.sensor.client._12_x.LocationValue _value) {
        this.val[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/sensor/client/12.x", "locationRange"));
