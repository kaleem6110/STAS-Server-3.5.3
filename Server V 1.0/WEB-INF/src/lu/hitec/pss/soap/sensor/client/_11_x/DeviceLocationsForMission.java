...
public class DeviceLocationsForMission  implements java.io.Serializable {
    ...
    private lu.hitec.pss.soap.sensor.client._11_x.LocationRange dtoLocationRange;
    ...
    public DeviceLocationsForMission(
           ...
           lu.hitec.pss.soap.sensor.client._11_x.LocationRange dtoLocationRange,
     ...
     */
    public lu.hitec.pss.soap.sensor.client._11_x.LocationRange getDtoLocationRange() {
        return dtoLocationRange;
    }
     ...
     */
    public void setDtoLocationRange(lu.hitec.pss.soap.sensor.client._11_x.LocationRange dtoLocationRange) {
        this.dtoLocationRange = dtoLocationRange;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/sensor/client/11.x", "deviceLocationsForMission"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/sensor/client/11.x", "locationRange"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
