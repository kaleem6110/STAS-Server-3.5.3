...
public class LocationValue  implements java.io.Serializable {
    ...
    private lu.hitec.pss.soap.sensor.client._11_x.LocationStatus geoFencingStatus;  // attribute
    ...
    public LocationValue(
           double alt,
           lu.hitec.pss.soap.sensor.client._11_x.LocationStatus geoFencingStatus,
           double hdg,
           double lat,
           double lng,
           double spd,
     ...
     */
    public lu.hitec.pss.soap.sensor.client._11_x.LocationStatus getGeoFencingStatus() {
        return geoFencingStatus;
    }
     ...
     */
    public void setGeoFencingStatus(lu.hitec.pss.soap.sensor.client._11_x.LocationStatus geoFencingStatus) {
        this.geoFencingStatus = geoFencingStatus;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/sensor/client/11.x", "locationValue"));
        ...
        attrField.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/sensor/client/11.x", "locationStatus"));
        typeDesc.addFieldDesc(attrField);
        attrField = new org.apache.axis.description.AttributeDesc();
