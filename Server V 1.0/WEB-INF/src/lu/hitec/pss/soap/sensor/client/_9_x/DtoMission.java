...
public class DtoMission  implements java.io.Serializable {
    ...
    /**
     * Gets the mwId value for this DtoMission.
     * 
     * @return mwId
     */
    ...
    /**
     * Sets the mwId value for this DtoMission.
     * 
     * @param mwId
     */
    ...
    /**
     * Gets the name value for this DtoMission.
     * 
     * @return name
     */
    ...
    /**
     * Sets the name value for this DtoMission.
     * 
     * @param name
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/sensor/client/9.x", "dtoMission"));
