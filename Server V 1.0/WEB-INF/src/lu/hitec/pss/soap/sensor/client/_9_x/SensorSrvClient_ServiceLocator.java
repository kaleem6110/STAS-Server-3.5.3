...
public class SensorSrvClient_ServiceLocator extends org.apache.axis.client.Service implements lu.hitec.pss.soap.sensor.client._9_x.SensorSrvClient_Service {
    ...
    public lu.hitec.pss.soap.sensor.client._9_x.SensorSrvClient_PortType getSensorSrvClientPort() throws javax.xml.rpc.ServiceException {
    ...
    public lu.hitec.pss.soap.sensor.client._9_x.SensorSrvClient_PortType getSensorSrvClientPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            lu.hitec.pss.soap.sensor.client._9_x.SensorSrvClientPortBindingStub _stub = new lu.hitec.pss.soap.sensor.client._9_x.SensorSrvClientPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (lu.hitec.pss.soap.sensor.client._9_x.SensorSrvClient_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                lu.hitec.pss.soap.sensor.client._9_x.SensorSrvClientPortBindingStub _stub = new lu.hitec.pss.soap.sensor.client._9_x.SensorSrvClientPortBindingStub(new java.net.URL(SensorSrvClientPort_address), this);
                _stub.setPortName(getSensorSrvClientPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://hitec.lu/pss/soap/sensor/client/9.x", "SensorSrvClient");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/sensor/client/9.x", "SensorSrvClientPort"));
        }
