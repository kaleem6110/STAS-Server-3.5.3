...
public class UnitReport  implements java.io.Serializable {
    ...
    private lu.hitec.pss.soap.sensor.client._9_x.Severity worstSeverity;
    ...
    public UnitReport(
           ...
           lu.hitec.pss.soap.sensor.client._9_x.Severity worstSeverity,
     ...
     */
    public lu.hitec.pss.soap.sensor.client._9_x.Severity getWorstSeverity() {
        return worstSeverity;
    }
     ...
     * @param worstSeverity
     */
    public void setWorstSeverity(lu.hitec.pss.soap.sensor.client._9_x.Severity worstSeverity) {
        this.worstSeverity = worstSeverity;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/sensor/client/9.x", "unitReport"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/sensor/client/9.x", "severity"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
