...
public class UnitId  implements java.io.Serializable {
    ...
    private lu.hitec.pss.soap.sensor.client._12_x.UnitType unitType;
     ...
     * @return unitType
     */
    public lu.hitec.pss.soap.sensor.client._12_x.UnitType getUnitType() {
        return unitType;
    }
     ...
     * @param unitType
     */
    public void setUnitType(lu.hitec.pss.soap.sensor.client._12_x.UnitType unitType) {
        this.unitType = unitType;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/sensor/client/12.x", "unitId"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/sensor/client/12.x", "unitType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
