...
public class SimpleCircularZone  extends lu.hitec.pss.soap.sensor.client._12_x.AbstractCircularZone  implements java.io.Serializable {
    private lu.hitec.pss.soap.sensor.client._12_x.Point center;
    ...
    public SimpleCircularZone(
           lu.hitec.pss.soap.sensor.client._12_x.Point center,
     ...
     * @return center
     */
    public lu.hitec.pss.soap.sensor.client._12_x.Point getCenter() {
        return center;
    }
     ...
     * @param center
     */
    public void setCenter(lu.hitec.pss.soap.sensor.client._12_x.Point center) {
        this.center = center;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/sensor/client/12.x", "simpleCircularZone"));
