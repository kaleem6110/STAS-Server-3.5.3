...
public class RangeLimit  implements java.io.Serializable {
    private lu.hitec.pss.soap.sensor.client._12_x.TimeRange timeRange;

    private int maxValues;  // attribute

    private lu.hitec.pss.soap.sensor.client._12_x.SubRangeType preferredSubRangeType;  // attribute

    public RangeLimit() {
    }

    public RangeLimit(
           lu.hitec.pss.soap.sensor.client._12_x.TimeRange timeRange,
           int maxValues,
           lu.hitec.pss.soap.sensor.client._12_x.SubRangeType preferredSubRangeType) {
     ...
     * @return timeRange
     */
    public lu.hitec.pss.soap.sensor.client._12_x.TimeRange getTimeRange() {
        return timeRange;
    }
     ...
     * @param timeRange
     */
    public void setTimeRange(lu.hitec.pss.soap.sensor.client._12_x.TimeRange timeRange) {
        this.timeRange = timeRange;
    }
     ...
     */
    public lu.hitec.pss.soap.sensor.client._12_x.SubRangeType getPreferredSubRangeType() {
        return preferredSubRangeType;
    }
     ...
     */
    public void setPreferredSubRangeType(lu.hitec.pss.soap.sensor.client._12_x.SubRangeType preferredSubRangeType) {
        this.preferredSubRangeType = preferredSubRangeType;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/sensor/client/12.x", "rangeLimit"));
        ...
        attrField.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/sensor/client/12.x", "subRangeType"));
        typeDesc.addFieldDesc(attrField);
