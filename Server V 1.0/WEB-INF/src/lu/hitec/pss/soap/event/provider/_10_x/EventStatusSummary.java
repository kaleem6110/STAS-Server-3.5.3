...
public class EventStatusSummary  implements java.io.Serializable {
    ...
    private lu.hitec.pss.soap.event.provider._10_x.NotificationStatusSummary[] notificationStatusSummaries;

    private lu.hitec.pss.soap.event.provider._10_x.NotificationsProcessingEventStatus notificationsProcessingEventStatus;
    ...
    public EventStatusSummary(
           ...
           lu.hitec.pss.soap.event.provider._10_x.NotificationStatusSummary[] notificationStatusSummaries,
           lu.hitec.pss.soap.event.provider._10_x.NotificationsProcessingEventStatus notificationsProcessingEventStatus) {
     ...
     */
    public lu.hitec.pss.soap.event.provider._10_x.NotificationStatusSummary[] getNotificationStatusSummaries() {
        return notificationStatusSummaries;
    }
     ...
     */
    public void setNotificationStatusSummaries(lu.hitec.pss.soap.event.provider._10_x.NotificationStatusSummary[] notificationStatusSummaries) {
        this.notificationStatusSummaries = notificationStatusSummaries;
    }

    public lu.hitec.pss.soap.event.provider._10_x.NotificationStatusSummary getNotificationStatusSummaries(int i) {
        return this.notificationStatusSummaries[i];
    }

    public void setNotificationStatusSummaries(int i, lu.hitec.pss.soap.event.provider._10_x.NotificationStatusSummary _value) {
        this.notificationStatusSummaries[i] = _value;
    }


    /**
     * Gets the notificationsProcessingEventStatus value for this EventStatusSummary.
     * 
     * @return notificationsProcessingEventStatus
     */
    public lu.hitec.pss.soap.event.provider._10_x.NotificationsProcessingEventStatus getNotificationsProcessingEventStatus() {
        return notificationsProcessingEventStatus;
    }


    /**
     * Sets the notificationsProcessingEventStatus value for this EventStatusSummary.
     * 
     * @param notificationsProcessingEventStatus
     */
    public void setNotificationsProcessingEventStatus(lu.hitec.pss.soap.event.provider._10_x.NotificationsProcessingEventStatus notificationsProcessingEventStatus) {
        this.notificationsProcessingEventStatus = notificationsProcessingEventStatus;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/event/provider/10.x", "eventStatusSummary"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/event/provider/10.x", "notificationStatusSummary"));
        elemField.setMinOccurs(0);
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/event/provider/10.x", "notificationsProcessingEventStatus"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
