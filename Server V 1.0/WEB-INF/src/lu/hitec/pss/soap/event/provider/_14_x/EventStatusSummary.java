...
public class EventStatusSummary  implements java.io.Serializable {
    ...
    private lu.hitec.pss.soap.event.provider._14_x.NotificationStatusSummary[] notificationStatusSummaries;

    private lu.hitec.pss.soap.event.provider._14_x.NotificationsProcessingEventStatus notificationsProcessingEventStatus;
    ...
    public EventStatusSummary(
           ...
           lu.hitec.pss.soap.event.provider._14_x.NotificationStatusSummary[] notificationStatusSummaries,
           lu.hitec.pss.soap.event.provider._14_x.NotificationsProcessingEventStatus notificationsProcessingEventStatus) {
     ...
     */
    public lu.hitec.pss.soap.event.provider._14_x.NotificationStatusSummary[] getNotificationStatusSummaries() {
        return notificationStatusSummaries;
    }
     ...
     */
    public void setNotificationStatusSummaries(lu.hitec.pss.soap.event.provider._14_x.NotificationStatusSummary[] notificationStatusSummaries) {
        this.notificationStatusSummaries = notificationStatusSummaries;
    }

    public lu.hitec.pss.soap.event.provider._14_x.NotificationStatusSummary getNotificationStatusSummaries(int i) {
        return this.notificationStatusSummaries[i];
    }

    public void setNotificationStatusSummaries(int i, lu.hitec.pss.soap.event.provider._14_x.NotificationStatusSummary _value) {
     ...
     */
    public lu.hitec.pss.soap.event.provider._14_x.NotificationsProcessingEventStatus getNotificationsProcessingEventStatus() {
        return notificationsProcessingEventStatus;
    }
     ...
     */
    public void setNotificationsProcessingEventStatus(lu.hitec.pss.soap.event.provider._14_x.NotificationsProcessingEventStatus notificationsProcessingEventStatus) {
        this.notificationsProcessingEventStatus = notificationsProcessingEventStatus;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/event/provider/14.x", "eventStatusSummary"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/event/provider/14.x", "notificationStatusSummary"));
        elemField.setMinOccurs(0);
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/event/provider/14.x", "notificationsProcessingEventStatus"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
