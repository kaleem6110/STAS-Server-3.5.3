...
public class EventSrvProviderProxy implements lu.hitec.pss.soap.event.provider._10_x.EventSrvProvider_PortType {
  private String _endpoint = null;
  private lu.hitec.pss.soap.event.provider._10_x.EventSrvProvider_PortType eventSrvProvider_PortType = null;
  ...
  private void _initEventSrvProviderProxy() {
    try {
      eventSrvProvider_PortType = (new lu.hitec.pss.soap.event.provider._10_x.EventSrvProvider_ServiceLocator()).getEventSrvProviderPort();
  ...
  public lu.hitec.pss.soap.event.provider._10_x.EventSrvProvider_PortType getEventSrvProvider_PortType() {
    if (eventSrvProvider_PortType == null)
      _initEventSrvProviderProxy();
