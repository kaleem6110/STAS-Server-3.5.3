...
<html>
    <head>
        ...
        <script type="text/javascript" src="<%=serverUrl%>js/ge/xmlhttputils.js"></script>
        ...
        <script type="text/javascript" src="http://www.google.com/jsapi?key=<%=geKey%>"></script>
        <script type="text/javascript" src="http://maps.google.com/maps/api/js?sensor=false"></script>
        <!--
        <script src="http://maps.google.com/maps?file=api&amp;v=2.x&amp;key=<%=geKey%>" type="text/javascript"></script>
        <script type="text/javascript" src="popupmarker.js"></script>
        <script src="http://maps.google.com/maps?file=api&amp;v=2&amp;key=<%=geKey%>" type="text/javascript"></script>
        <script type="text/javascript" src="http://maps.google.com/maps/api/js?sensor=false"></script>
