...
<html:form action="WizardHomeAction"
	onsubmit="return validateAll();" enctype="multipart/form-data">
	  <fieldset  style="width: 90%">
	<table width='40%' align="left">
		<tr>
			<td colspan="3"><input type="radio" name="ecosystem"
		...
		<tr style="display:none" id="fileName">
			...
			<bean:message bundle="ecoweb" key="ecomodel.label.create.newfilename" /><font color="red" size="2">*</font>
				 <input type="text"	id="ecosystemFileName" name="ecosystemFileName" class="medium"
