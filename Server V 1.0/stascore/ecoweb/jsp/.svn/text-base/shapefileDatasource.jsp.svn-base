...
<script>
 ...
 {
     if(dijit.byId('datasourceDesc').attr('value').length > 500)
     {
         //alert("Length of text description should be less than 500");
		return false;
     }
     return true;
      ...
      <table width="1000" cellspacing="0" cellpadding="0">
        ...
        <table width="100%" cellspacing="0" cellpadding="0" >
		            ...
		            <tr>
			          <td><logic:notPresent name="ecoDatasourceListData">
							...
							value="<bean:write name="ecoDatasourceListData" property="datasourceName"/>" onblur="validateDataSourceName(this);"/> </logic:notEqual>
		                      <logic:equal name="modeType" value="insert">
				                <input type="text"  id="datasourceName" name="datasourceName" class="medium"
                                    dojoType="dijit.form.ValidationTextBox" required="true" trim="true" ucfirst="true" onBlur="validateDataSourceName(this);" 
			...
			<table border=0 >
		       ...
		       <select name="shapeFile"  id="shapeFile"  dojoType="dijit.form.FilteringSelect"  store="filePathStore"     searchAttr="filePath" >
		<!--	<select name="shapeFile"  id="shapeFile"  dojoType="dijit.form.FilteringSelect"  store="filePathStore"     searchAttr="filePath" onChange="enableSelectFile(this)"> -->
                <option value=""></option>
              </select>
			  </td>
			  </tr>
			  ...
			  <td colspan="2" style="padding-top:30px;">
				<button dojoType="dijit.form.Button" id="selectFile" type="button" onClick="showMultiFileDialog('Choose Shape File','Shape Files:*.shp;*.prj;*.dbf')" >
              <bean:message key="datasource.selectFile" bundle="ds" />
              </button>
			  </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td  height="28" width="200" align="left" style="padding-left:3px;">
                        <textarea  id="datasourceDesc"  name="datasourceDesc" dojoType="dijit.form.SimpleTextarea" rows="5" cols="30"   style="width:194px"><logic:present name="ecoDatasourceListData"><bean:write name="ecoDatasourceListData" property="datasourceDesc" /></logic:present></textarea>            
            </td>
           <td width="30" height="28">&nbsp;</td>
            <td  align="right"  class="bodytext" style="padding-right:10px;"><strong>
              <bean:message key="datasource.dataRenderType" bundle="ds" />
              : </strong></td>
            <td style="padding-left:3px;"><select id="dataRenderTypeId" name="dataRenderTypeId"
    ...
    <script>
		dojo.addOnLoad(loadFormValues); 
			function loadFormValues(){
				...
				//dijit.byId('selectFile').setAttribute('disabled', true);
