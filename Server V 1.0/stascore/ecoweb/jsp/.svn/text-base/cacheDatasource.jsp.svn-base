				...
				<table width="100%">
						...
						<table>
							<tr>
								<td><input type="text" id="datasourceName"
									...
									onkeypress="enableDisable(this)" /></td>
							</tr>
							<tr>
					...
					<tr>
						...
						<td><select id="driverName"
							...
							autoComplete="false" invalidMessage="Invalid driverName"
						...
						<td><input type="text" id="dbUrl" name="dbUrl" class="urlTxt"
							...
							onkeyup=" checkConnectionProps(this, 'insert')" /></td>
					</tr>
					<tr>
						<th><bean:message bundle="ecoweb"
					...
					<!--	<tr>
						<td colspan="4" align="right">
							<button dojoType="dijit.form.Button" onClick="testConnection()">
								<img src="ecoweb/images/ecoweb/checked.png" style="display:none"  id="indicatorSuccess"/> Connect  <img src="ecoweb/images/ecoweb/indicator.gif" style="display:none"  id="indicator"/>
							</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<!--			
							<div dojoType="dijit.ProgressBar" style="width:100px;display:none"
					...
					<tr>
						...
						<td colspan="3"><select id="tableName"
							...
							autoComplete="false" invalidMessage="Invalid tableName"
					...
					<tr>
						...
						<td><select id="longitude"
							...
							autoComplete="false" invalidMessage="Invalid Longitude"
						...
						<td><select id="latitude"
							...
							autoComplete="false" invalidMessage="Invalid latitude"
							store="columnStore" searchAttr="column"
							onchange="enableDisableColumns(this)">
					...
					<tr>
						...
						<td><select id="coordinates"
							...
							autoComplete="false" invalidMessage="Invalid order"
							store="columnStore" searchAttr="column"
							onchange="enableDisableColumns(this)">
						</select></td>
						<td><bean:message bundle="ecoweb"
						...
						<td><select id="order" dojoType="dijit.form.FilteringSelect"
							name="order" autoComplete="false" invalidMessage="Invalid order"
							store="columnStore" searchAttr="column">
							<option value=""><bean:message
								key="ecoweb.cachedatasource.select" bundle="ecoweb" /></option>
						</select></td>
		...
		<table width="95%" style="margin-left: 3px; margin-right: 3px">
			<tr align="center">
				...
				<table width="100%">
					...
					<!--	<tr>
						<td colspan="4" align="right">
							<button dojoType="dijit.form.Button" onClick="setDBUrl(dijit.byId('driverName').attr('value'));setSavedDBDtls()	">
							<img src="ecoweb/images/ecoweb/checked.png" style="display:none"  id="indicatorSuccess"/> Connect  <img src="ecoweb/images/ecoweb/indicator.gif" style="display:none"  id="indicator"/>
							</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
							<!--
							<div dojoType="dijit.ProgressBar" style="width:100px;display:none"
         jsId="jsProgress" id="downloadProgress"></div> 
					...
					<tr>
						<td colspan="4">
						<div class="formQuestion"><span class="noticeMessage"></span>
						<span>Input parameters</span></div>
						</td>
					</tr> -->
					<tr>
						<td colspan="4">&nbsp;</td>
					...
					<!--					<tr>
						<th><bean:message bundle="ecoweb" key="ecomodel.datasources.frameset.database.label.dbquery" />:</th>
						<td><textarea dojoType="dijit.form.Textarea" id="query" class="txtareamedium"
							name="query" ><bean:write name="ecoDatasourceListData" property="query" />
												</textarea></td>
						<td><bean:message bundle="ecoweb" key="ecomodel.datasources.frameset.database.label.dbtablename" />:</td>
						<td><select id="tableName"  dojoType="dijit.form.FilteringSelect"
							name="tableName"    autoComplete="false"     invalidMessage="Invalid tableName"  store="tableStore" searchAttr="table" onchange="loadData('LoadDBColumns',this)">												
