...
<div class="headerMenu">
	<ul>
		<li id="pwd" class="selected">
			<span class="whiteBoldText" style="color:#FFF"><bean:message key='admin.changepassword.title' bundle='admin'/></span>
		</li>	
		<li id="logout">
...
var selectedMenuId = 0;
	function loadToIFrameUrl(url, menuId){
		...
		if(validateUrl == ''){
			alert("<bean:message key='admin.msg.invalid.url' bundle='admin'/>", "<bean:message key='admin.alert.title' bundle='admin'/>");
			return false;
		}
		try{
