...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    ...
    <script type="text/javascript" src="<%=serverUrl%>/jsp/offlineslviewer/silverlight.js"></script>
    <script type="text/javascript" src="<%=serverUrl%>/jsp/offlineslviewer/viewerfunctions.js"></script>
    <script type="text/javascript" src="<%=serverUrl%>/jsp/offlineslviewer/SilverlightSessionTimeOut.js"></script>
...
<body>
    ...
    <div id="silverlightControlHost">
        <object data="data:application/x-silverlight-2," type="application/x-silverlight-2"
            ...
            <param name="source" value="<%=serverUrl%>/jsp/offlineslviewer/ClientBin/OfflineRadMap.xap" />
            <param name="onError" value="onSilverlightError" />
            <param name="background" value="transparent" />
            <param name="minRuntimeVersion" value="3.0.40624.0" />
            <param name="autoUpgrade" value="true" />
            <param name="InitParams" value="coreServerUrl=<%=coreServerUrl%>,ServerUrl=<%=adminServerUrl%>,bingMapCulture=<%=bingMapCulture%>,GroupId=<%=groupId%>,ModuleId=<%=moduleId%>,DomainId=<%=domainId%>,LanguageId=<%=languageId%>,DefaultMap=<%=defaultMap%>,ISHighlightPlacement=<%=isHighlightPlacement%>,DefaultRange=<%=defaultRange%>,selectFavorite=<%=selectFavorite%>" />
