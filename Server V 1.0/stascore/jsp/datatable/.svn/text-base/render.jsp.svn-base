			...
			if(artifacts==null){
				...
				for (int i = 0; i < artifacts.size(); i++){%>
		 		...
		 		for(int j = 0; j < columnNames.length; j++) {%>
		  			<!--
		  			<td><a href="javascript:void(executeEventAttributeZoom('-177.014','33.2394'));"><%=ArtifactUtils.getAttributeValue(columnNames[j], artifact)%></a></td>
		  			 -->
...
<%
	...
	out.println("Ecoxmpl: "+request.getParameter("ecoxmpl")+"<br>");
	out.println("Ecosid: "+request.getParameter("ecosid")+"<br>");
	out.println("Artefact Name: "+request.getParameter("artefactName")+"<br>");
%>
-->
</body>
</html>