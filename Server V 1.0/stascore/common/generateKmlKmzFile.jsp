            				...
            				<table  border="0">
									...
									<tr>
										...
										<bean:message key="kmlGen.ecoexpml" bundle="kmlGen"/></label><label class="error">*</label><label class="label">:</label>
			         					...
			         					<td>
												...
												<select name="cmbKmlKmz" dojoType="dijit.form.FilteringSelect" id="cmbKmlKmz" onchange = "onEcoSystemChange();">
            	                	...
            	                	<tr> 
                    	            	...
                    	            	<td align="left" style="padding-top:10px;">
                        	            	<input type="radio" name="btnKMLKMZRadio" id="idKMLRadio" value="kml">  <label class="label"><bean:message key="kmlGen.kml" bundle="kmlGen"/></label>  &nbsp;&nbsp;
                            	        	<input type="radio"  name="btnKMLKMZRadio" checked value="kmz"> <label class="label	"><bean:message key="kmlGen.kmz" bundle="kmlGen"/></label>
                                	    	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                		</td>
                            		</tr>
				...
				<table width="101.2%">
					...
					<tr colspan="2" class="barColor">
    					...
    					<td  colspan="2"  align="center">	
        					...
        					<button dojoType="dijit.form.Button"  id="idGenerate" name="btnGenerate" type="submit" onClick="return performSubmit();"> <bean:message key="kmlGen.generate" bundle="kmlGen"/>  
							</button>
