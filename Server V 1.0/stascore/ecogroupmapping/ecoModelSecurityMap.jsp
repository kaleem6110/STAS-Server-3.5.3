...
<td align="left">
 ...
 <select id = "selectedRole" name="selectedRole" dojoType="dijit.form.FilteringSelect"   onchange="populateForm('role');loadModuleGroupMapping()" >
 <option value=""></option>
                                    <% if(userRoles != null)
                                    {
...
<select id = "mapModule" name="mapModule" dojoType="dijit.form.FilteringSelect"   onchange="searchForRoleEcoModels();" >
 <option value=""></option>
                                    <% if(mapModules != null)
                                    {
...
<html:select property="ecoCategories" size='5' multiple= "true" style='display:none'>
 ...
 <tr><td> <input type="text" id="displayNameText" style="width:'100px'"     > </td></tr>
 <tr><td align="left"><b><input type="checkbox" id="selectedInput"     >Selected </b> </td></tr>
 ...
 <tr><td> 
   <table >
   <tr>
   <td> <input type="text" id="ecoCategoryTextInput" style="width:100px" readonly   > 
