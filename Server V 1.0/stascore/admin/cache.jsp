...
<table width="100%" cellspacing="0" cellpadding="0" align="center"  border="0" >
                ...
                <td height="27" align="left" class="tableBgColor">
                    <table>
                         <tbody>
                                <tr>
                                <td >
                                <input type="radio" name="btnRadioCache" id="cacheRadioBtn" checked="true"  value="clearAll" onClick="enableDisable(this);"><label class="label"><bean:message key="cache.clearall" bundle="cache"/></label>
                                    </td>
                                    <td>&nbsp;
                                    </td>
                                </tr>
                                ...
                                <tr valign="top">
                                    <td align="right"><input type="radio"  id="btnRadioCacheId"  name="btnRadioCache"  value="clearKey" onClick="enableDisable(this);"><label class="label"><bean:message key="cache.clear" bundle="cache"/></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    </td>
                                    <td align="center">
                               
                                        <select dojoType="dijit.form.FilteringSelect" id="cmbCacheKey" name="cmbCacheKey"  autoComplete="false"     invalidMessage="Invalid value" >
  ...
  <tr  height="30" colspan="2" class="barColor" >
       <td height="30" colspan="1" class="barColor" align="left" style="padding-left:340px;">    
            <button dojoType="dijit.form.Button"  type="button" onClick="goToDBHomePage()"><bean:message key="cache.home" bundle="cache"/> </button>
            <button dojoType="dijit.form.Button" type="button"  id="idSubmit" name="btnSubmit"   onclick="return submitForm();" > <bean:message key="cache.submit" bundle="cache"/> </button>
