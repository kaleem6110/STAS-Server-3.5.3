...
<form name="frmShp2DBMapping" method="post" action="<%=ServerUtils.getContextName(request)%>/admin/shp2dbmappingadd.jsp">
...
<table id = "selectionPanel"  style = "padding-left : 67px;" width="40%" cellspacing="0" cellpadding="0" border = "0">
	...
	<tr>
		...
		<td align = "left" style = "padding-top:20px;">
							<select name="cmbDBModels" id="cmbDBModels" dojoType="dijit.form.FilteringSelect" >
	...
	<tr>
		...
		<td style = "padding-top:10px;">
							...
							<select name="cmbShapeFile" id="cmbShapeFile" dojoType="dijit.form.FilteringSelect">
								<option value=""><bean:message key="validation.msg.select" bundle="splchvalidation"/></option>
								<%
