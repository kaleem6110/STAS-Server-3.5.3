...
public class NotificationStatusSummary  implements java.io.Serializable {
    private lu.hitec.pss.soap.event.provider._5_x.NotificationStatus notificationStatus;
    ...
    public NotificationStatusSummary(
           lu.hitec.pss.soap.event.provider._5_x.NotificationStatus notificationStatus,
     ...
     */
    public lu.hitec.pss.soap.event.provider._5_x.NotificationStatus getNotificationStatus() {
        return notificationStatus;
    }
     ...
     */
    public void setNotificationStatus(lu.hitec.pss.soap.event.provider._5_x.NotificationStatus notificationStatus) {
        this.notificationStatus = notificationStatus;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/event/provider/5.x", "notificationStatusSummary"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/event/provider/5.x", "notificationStatus"));
