...
public class RangeDetails  implements java.io.Serializable {
    private lu.hitec.pss.soap.sensor.client._5_x.TimeRange availableTimeRange;

    private lu.hitec.pss.soap.sensor.client._5_x.TimeRange requestedTimeRange;

    private lu.hitec.pss.soap.sensor.client._5_x.SubRangeDetails subRangeDetails;

    public RangeDetails() {
    }

    public RangeDetails(
           lu.hitec.pss.soap.sensor.client._5_x.TimeRange availableTimeRange,
           lu.hitec.pss.soap.sensor.client._5_x.TimeRange requestedTimeRange,
           lu.hitec.pss.soap.sensor.client._5_x.SubRangeDetails subRangeDetails) {
     ...
     */
    public lu.hitec.pss.soap.sensor.client._5_x.TimeRange getAvailableTimeRange() {
        return availableTimeRange;
    }
     ...
     */
    public void setAvailableTimeRange(lu.hitec.pss.soap.sensor.client._5_x.TimeRange availableTimeRange) {
        this.availableTimeRange = availableTimeRange;
    }
     ...
     */
    public lu.hitec.pss.soap.sensor.client._5_x.TimeRange getRequestedTimeRange() {
        return requestedTimeRange;
    }
     ...
     */
    public void setRequestedTimeRange(lu.hitec.pss.soap.sensor.client._5_x.TimeRange requestedTimeRange) {
        this.requestedTimeRange = requestedTimeRange;
    }
     ...
     */
    public lu.hitec.pss.soap.sensor.client._5_x.SubRangeDetails getSubRangeDetails() {
        return subRangeDetails;
    }
     ...
     */
    public void setSubRangeDetails(lu.hitec.pss.soap.sensor.client._5_x.SubRangeDetails subRangeDetails) {
        this.subRangeDetails = subRangeDetails;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/sensor/client/5.x", "rangeDetails"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/sensor/client/5.x", "timeRange"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/sensor/client/5.x", "subRangeDetails"));
