...
public class LocationSummary  implements java.io.Serializable {
    private lu.hitec.pss.soap.sensor.client._5_x.LocationValue latest;
    ...
    public LocationSummary(
           lu.hitec.pss.soap.sensor.client._5_x.LocationValue latest,
     ...
     * @return latest
     */
    public lu.hitec.pss.soap.sensor.client._5_x.LocationValue getLatest() {
        return latest;
    }
     ...
     * @param latest
     */
    public void setLatest(lu.hitec.pss.soap.sensor.client._5_x.LocationValue latest) {
        this.latest = latest;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/sensor/client/5.x", "locationSummary"));
