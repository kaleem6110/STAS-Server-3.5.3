...
public class ProbeRange  implements java.io.Serializable {
    ...
    private lu.hitec.pss.soap.sensor.client._5_x.ProbeValue[] val;
    ...
    public ProbeRange(
           ...
           lu.hitec.pss.soap.sensor.client._5_x.ProbeValue[] val) {
     ...
     * @return val
     */
    public lu.hitec.pss.soap.sensor.client._5_x.ProbeValue[] getVal() {
        return val;
    }
     ...
     * @param val
     */
    public void setVal(lu.hitec.pss.soap.sensor.client._5_x.ProbeValue[] val) {
        this.val = val;
    }

    public lu.hitec.pss.soap.sensor.client._5_x.ProbeValue getVal(int i) {
        return this.val[i];
    }

    public void setVal(int i, lu.hitec.pss.soap.sensor.client._5_x.ProbeValue _value) {
        this.val[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/sensor/client/5.x", "probeRange"));
