...
public class CopyOfRBRegionsUtils1 implements IEPICConstants {
	...
	public static String[] getZoneNames(GeoArtifact artifact, UserBean userbean, String layerName, long layerId, String startsWith){
		long moduleId = CopyOfRBRegionsUtils1.getModuleId(layerId);
		Rubberbandregions rubberbandregions = CopyOfRBRegionsUtils1.getUserModuleRubberbandregion(userbean.getDomainId(), userbean.getLanguageId(), 
