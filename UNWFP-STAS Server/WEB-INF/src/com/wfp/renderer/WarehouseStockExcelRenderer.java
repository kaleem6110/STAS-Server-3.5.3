...
import com.enterprisehorizons.magma.designtime.artifact.ArtifactCanvas;
...
public class WarehouseStockExcelRenderer extends BaseDashboardRenderer
	...
	private static final String DATE_TYPE = Date.class.getName();
	...
	protected StringBuffer render(Map params) {
		...
		ArtifactCanvas artifact = (ArtifactCanvas) getCanvas();
		//System.out.println(params.get(IServerConstants.PARAM_DASHBOARD_SEARCH_CRTIERIA));
		...
		if (datasource != null && datasource.size() > 0) {
			...
			//buff.append(XML_START_TAG + ELEMENT_ATTRIBUTES + XML_END_TAG);
			int log = 0;
			// iterate over record by record & map the data with warehouse &
			// convert he same to XML Data
