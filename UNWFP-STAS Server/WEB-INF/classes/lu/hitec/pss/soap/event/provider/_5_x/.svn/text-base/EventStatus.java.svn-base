...
public class EventStatus implements java.io.Serializable {
    ...
    public static final EventStatus NEW = new EventStatus(_NEW);
    public static final EventStatus OPEN = new EventStatus(_OPEN);
    public static final EventStatus FAILED = new EventStatus(_FAILED);
    public static final EventStatus DONE = new EventStatus(_DONE);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/event/provider/5.x", "eventStatus"));
    }
    /**
