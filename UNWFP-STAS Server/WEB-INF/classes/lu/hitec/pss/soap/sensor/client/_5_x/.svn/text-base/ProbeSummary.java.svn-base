...
public class ProbeSummary  implements java.io.Serializable {
    private lu.hitec.pss.soap.sensor.client._5_x.ProbeValue latest;

    private lu.hitec.pss.soap.sensor.client._5_x.ValueRange range;
    ...
    public ProbeSummary(
           lu.hitec.pss.soap.sensor.client._5_x.ProbeValue latest,
           lu.hitec.pss.soap.sensor.client._5_x.ValueRange range,
     ...
     * @return latest
     */
    public lu.hitec.pss.soap.sensor.client._5_x.ProbeValue getLatest() {
        return latest;
    }
     ...
     * @param latest
     */
    public void setLatest(lu.hitec.pss.soap.sensor.client._5_x.ProbeValue latest) {
        this.latest = latest;
    }
     ...
     * @return range
     */
    public lu.hitec.pss.soap.sensor.client._5_x.ValueRange getRange() {
        return range;
    }
     ...
     * @param range
     */
    public void setRange(lu.hitec.pss.soap.sensor.client._5_x.ValueRange range) {
        this.range = range;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/sensor/client/5.x", "probeSummary"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/sensor/client/5.x", "probeValue"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("range");
        elemField.setXmlName(new javax.xml.namespace.QName("", "range"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/sensor/client/5.x", "valueRange"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
