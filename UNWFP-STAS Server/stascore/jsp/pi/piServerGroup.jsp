...
<body style="margin:0px">
    <object id="PIServerGroup" width="101.2%" height="100%">
            <param name="movie" value="swf/admin/PIServerGroup.swf<%=swfParams%>" />
            <param name="quality" value="high" />
            <param name="bgcolor" value="#FFFFFF" />
            <param name="wmode" value="transparent">
            <param name="allowScriptAccess" value="sameDomain" />
            <embed src="swf/admin/PIServerGroup.swf<%=swfParams%>" quality="high" bgcolor="#FFFFFF"
