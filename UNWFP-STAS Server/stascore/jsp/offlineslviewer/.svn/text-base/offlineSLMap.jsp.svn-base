...
<body>
    ...
    <div id="silverlightControlHost">
        <object data="data:application/x-silverlight-2," type="application/x-silverlight-2"
            ...
            <param name="InitParams" value="coreServerUrl=<%=coreServerUrl%>,ServerUrl=<%=adminServerUrl%>,bingMapCulture=<%=bingMapCulture%>,GroupId=<%=groupId%>,ModuleId=<%=moduleId%>,DomainId=<%=domainId%>,LanguageId=<%=languageId%>,DefaultMap=<%=defaultMap%>,SessionTimeInterval=<%=SessionTimeInterval%>,SessionAlertTime=<%=SessionAlertTime%>,SessionAlert=<%=sessionAlert%>,ISHighlightPlacement=<%=isHighlightPlacement%>,DefaultRange=<%=defaultRange%>" />
