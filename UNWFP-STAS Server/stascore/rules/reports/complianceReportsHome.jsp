        ...
        <table width="900" cellspacing="0" cellpadding="0" border="0">
            <tr>
                <td  class="pageTitle paddingTitle">      
                    <bean:message key="rules.generateReport.header" bundle="rules" />
                </td>
            </tr>
            <tr>
               <td class="paddingTitleDesc">
                    <bean:message key="rules.generateReport.description" bundle="rules" />
                </td>  
            </tr>
            <tr>
            ...
            <td>
                <div dojoType="dijit.layout.ContentPane" region="center" style="font-size:13px;font-weight:bold;color:#FFFFFF; text-align:center;vertical-align:middle;" class="thumbnail-itemOut" onClick="renderPage('<%=ServerUtils.getContextName(request)%>/searchToGenerateNercReportAction.do?operation=searchNercReportGenerateData')">
