...
-->
                ...
                <tr>
                    <td colspan="5" class="barColor" align="right" width="1000px">
                        ...
                        <button dojoType="dijit.form.Button"  type="button"   name="btnBack"    onclick="window.location =  '<%=ServerUtils.getContextName(request)%>/complianceReportsDataFeedHome.do'">
