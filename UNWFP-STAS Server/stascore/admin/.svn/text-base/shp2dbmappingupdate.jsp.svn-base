...
<%@ include file="/common/style.jsp"%>	<script type="text/javascript" src="<%=ServerUtils.getContextName(request)%>/js/dojo/dojo.js" djConfig="isDebug: false, parseOnLoad: true"></script>
	...
	<table width="101.2%" cellspacing="0" cellpadding="0" border="0" >
     	<tr>
	        <td style = "padding-left : 67px;">    
		        <table>
	    		    <tr>
		   			    <td height="60px" style = "padding-top : 30px;" align="left" valign="top" class="pageTitle paddingTitle" style="padding-left:0px"><bean:message key="shpDbMap.shpToDataMapUpdate" bundle="shpDbMap"/>
	    ...
	    <tr>
		    <td>
		        <table  border="0" align="center" width="100%">
					...
					<tr>
                        <td width="12%" align="right" style="padding-top:10px"><label class="label"><bean:message key='shpDbMap.dbmodel.label' bundle='shpDbMap'/> :</label>
                        </td>
                        <td width="60%" class="bodytext" style="padding-top:11px" valign="top">&nbsp;<%=dbModelName%>
                        </td>
						<td>&nbsp;</td>
                    </tr>
                    <tr>
                        <td align="right" style="padding-top:10px"><label class="label" ><bean:message key='shpDbMap.shapefile.label' bundle='shpDbMap'/>:</label>
                        </td>
                        <td class="bodytext" style="padding-top:10px" align="top">  &nbsp;<%=shapeFileName%>
                        </td>
						<td>&nbsp;</td>
                    </tr>
                    <tr>
                        <td align="right" style="padding-top:10px"><label class="label" align="top">[ATTR=<i>VALUE</i>] :</label>
                        </td>
			    ...
			    <table width="100%" border="0" cellpadding="2" cellspacing="2">
				    ...
				    <tr>
						...
						<td   class="bodytext" style="padding-top:10px" >
							<select id = "<%=attrMappingDef[i].getFieldName()%>" name="<%=attrMappingDef[i].getFieldName()%>" dojoType="dijit.form.FilteringSelect" onChange="return showOrHideCustomText(this);">
						...
						<td class="bodytext" style="padding-top:0px">
						    <div id="div<%=attrMappingDef[i].getFieldName()%>" style="visibility:<%=(attrMappingDef[i].getCustomValue() == null ? "hidden" : "visible")%>;">
								<input type="text" name="txt<%=attrMappingDef[i].getFieldName()%>" dojoType="dijit.form.ValidationTextBox" 
									value="<%=(attrMappingDef[i].getCustomValue() == null ? "&nbsp;" : attrMappingDef[i].getCustomValue())%>" 
									<%if(attrMappingDef[i].getCustomValue() == null){%> disabled<%}%> MAXLENGTH=100>
							</div>
					    </td>           
					</tr>
						<%
					...
					<tr valign="top">
						...
						<td colspan="2" class="bodytext" style="padding-top:10px"><select id="cmbCollator" name="cmbCollator" dojoType="dijit.form.FilteringSelect" onChange="return showOrHideRadiusCollatorDiv(this);">
							    <option value="" ><bean:message key="validation.msg.select" bundle="splchvalidation"/> </option>
			...
			<td colspan="4" align="left" style="padding-left:195px;padding-top:10px;" >
				<div id="divRadiusCollator" style="visibility:<%=(collatorType.indexOf("MergingTieLineCollator") > 0 ? "visible" : "hidden")%>;">                    <table border="0" align="left" width="100%">
					    <tr>
							...
							<td  class="bodytext" width="19%" style="padding-top:0px">&nbsp;<input type="text" dojoType="dijit.form.ValidationTextBox"  name="txtRadius" id ="txtRadius" value="<%=radius%>" onKeyUp="enableButtons()" MAXLENGTH=100></td>
                                   <%}else{%>
							<td><input type="text" dojoType="dijit.form.ValidationTextBox"  name="txtRadius" id ="txtRadius" value="<%=radius%>" onKeyUp="enableButtons()"></td>
								   <%}%>
						    ...
						    <td> 
					  	        ...
					  	        <select id="cmbCollateBy" name="cmbCollateBy" onChange="enableButtons()" dojoType="dijit.form.FilteringSelect">
