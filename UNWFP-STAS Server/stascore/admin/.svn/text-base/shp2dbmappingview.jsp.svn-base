...
<tr>
              ...
              <td height="20px" style = "padding-top : 30px;" align="left" valign="top"  class="pageTitle paddingTitle" style = "padding-left : 0px;"><strong><bean:message key="shpDbMap.shpToDataMapView" bundle="shpDbMap"/></strong>
...
<tr>
            ...
            <tr>
                ...
                <tr>
                    ...
                    <td colspan="2" class="bodytext"><%=mappingDef.getDbModel()%>
                    </td>
                </tr>
                <tr>
                   ...
                   <td><label class="label"><bean:message key="shpDbMap.shapefile.label" bundle="shpDbMap"/></label>
                    ...
                    <td colspan="2" class="bodytext"> <%=mappingDef.getShapeFile()%>
                    </td>
                </tr>
				</table>
				</td>
