...
<html:form action="monitorCacheAction.do">
									...
									<tr>
										<td>
											<table width="100%" id="<%=i%>" style="display:none">
												...
												<logic:iterate id="cache" name="cacheList" indexId="cacheListCount" property="value">
												<tr class="bgcolor" onMouseOver="hover(this);" onMouseOut="unHover(this)">
													<td align="left" valign="middle">&nbsp;&nbsp;${cacheListCount+1}</td>
													<td align="left" valign="middle">&nbsp;&nbsp;<bean:write name='cache' property='value.cacheKey' /></td>
													<td align="left" valign="middle">&nbsp;&nbsp;<bean:write name='cache' property='value.cacheClass' /></td>
													<td align="left" valign="middle">&nbsp;&nbsp;<bean:write name='cache' property='value.noOfElements' /></td>
													<td align="left" valign="middle">&nbsp;&nbsp;<bean:write name='cache' property='value.cacheType' /></td>
												</tr>
												</logic:iterate>
											</table>
										</td>
