...
document.write('<table id="fc" Style="position: absolute; margin-left: 168px; margin-top: 20px; border-collapse:collapse;background:#FFFFFF;border:1px solid #ABABAB;display:none" cellpadding=2>');
...
var updobj;
function lcs(controlName) {
    var ielem = document.getElementById(controlName);
	//var ielem = document.forms[0].controlName;
