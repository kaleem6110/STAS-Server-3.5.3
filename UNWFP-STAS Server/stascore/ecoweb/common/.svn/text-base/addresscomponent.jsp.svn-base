...
<table width="880" cellspacing="0" cellpadding="0" class="tableBgColor">
                  <tr>
                      <td colspan="7">
			...
			<strong><bean:message key="datasource.address" bundle="ds" />  :</strong>
			  ...
			  <td    width="20%"><select id="address" 
                            dojoType="dijit.form.FilteringSelect"  name="address"    autoComplete="false"     invalidMessage="Invalid Address Field"  store="columnStore" searchAttr="label" onChange="enableDisableColumns(this);resetNonAddressFields(this);" >
			...
			<td></td>
			  <td    width="20%"><select id="addCity" 
                            dojoType="dijit.form.FilteringSelect"  name="addCity"    autoComplete="false"     invalidMessage="Invalid Address Field"  store="columnStore" searchAttr="label" onChange="enableDisableColumns(this);resetNonAddressFields(this);">
                <option value=""><bean:message key="datasource.select" bundle="ds" /></option>
              </select></td>
			   <td width="10%">&nbsp;&nbsp;</td> 
						<td width="10%" align="right" class="bodytext" style="padding-right:12px;">
			...
			<td></td>
			  <td    width="20%"><select id="addCounty" 
                            dojoType="dijit.form.FilteringSelect"  name="addCounty"    autoComplete="false"     invalidMessage="Invalid Address Field"  store="columnStore" searchAttr="label" onChange="enableDisableColumns(this);resetNonAddressFields(this);" >
                <option value=""><bean:message key="datasource.select" bundle="ds" /></option>
              </select></td>
 ...
 <tr>
			...
			<strong><bean:message key="datasource.state" bundle="ds" />  :</strong>
			  ...
			  <td    width="20%"><select id="addState" 
                            dojoType="dijit.form.FilteringSelect"  name="addState"    autoComplete="false"     invalidMessage="Invalid Address Field"  store="columnStore" searchAttr="label" onChange="enableDisableColumns(this);resetNonAddressFields(this);">
                <option value=""><bean:message key="datasource.select" bundle="ds" /></option>
              </select>
			  </td>
                      <td width="10%">&nbsp;&nbsp;</td> 
			...
			<td></td>
			  <td    width="20%"><select id="addCountry" 
                            dojoType="dijit.form.FilteringSelect"  name="addCountry"    autoComplete="false"     invalidMessage="Invalid Address Field"  store="columnStore" searchAttr="label" onChange="enableDisableColumns(this);resetNonAddressFields(this);">
                <option value=""><bean:message key="datasource.select" bundle="ds" /></option>
              </select></td>
			   <td width="10%">&nbsp;&nbsp;</td> 
						<td width="10%" align="right" class="bodytext" style="padding-right:12px;">
			...
			<td></td>
			  <td    width="20%"><select id="addZipCode" 
                            dojoType="dijit.form.FilteringSelect"  name="addZipCode"    autoComplete="false"     invalidMessage="Invalid Address Field"  store="columnStore" searchAttr="label" onChange="enableDisableColumns(this);resetNonAddressFields(this);" >>
                <option value=""><bean:message key="datasource.select" bundle="ds" /></option>
              </select></td>
