...
function addNewRow() {
	    ...
	    var td0 = document.createElement("TD");
   	    ...
   	    td0.innerHTML = "<strong><span class='bodytext' id='firstLabel"+count+"'> <bean:message key='datasource.attribute.label' bundle='ds'/> "+count+" </span></strong>";
	    ...
	    td21.setAttribute("nowrap","nowrap");
   	    ...
   	    var removeHTML="<img src='<%=ServerUtils.getContextName(request)%>/images/portal/icon_dash_1.png'    style='cursor: hand;'  onclick='javascript:removeRow(this.parentNode.parentNode)' />";
   	    td21.innerHTML=removeHTML;
   	    
   	    var tmpFirstDSNAttr="mapFirstDSNAttr"+count;
   	    var tmpWithSecondDSNAttr="mapWithSecondDSNAttr"+count 	 

		var strHtml = "<select name='"+tmpFirstDSNAttr+"'  id='"+tmpFirstDSNAttr+"'  dojoType='dijit.form.FilteringSelect' trim='value' class='selectbox'  store='firstAttrStore' searchAttr='attr'> <option value=''></option> </select>";
	    ...
	    var strHtml1 = "<select name='"+tmpWithSecondDSNAttr+"'  id='"+tmpWithSecondDSNAttr+"'   trim='value' dojoType='dijit.form.FilteringSelect' class='selectbox' store='secondAttrStore'  searchAttr='attr'> <option value=''></option> </select>";
...
<form name="newEcoDataSourceForm" method="post" action="<%=ServerUtils.getContextName(request)%>/UpdateDataSource.do">
  ...
  <!--  
                ...
                ***************************************************************************************
                 -->
    <logic:present name="ecoDatasourceListData">                              
       <input type="hidden" name="mappingCount" value="<%=firstAttList.size()%>"/>
    </logic:present>
                ...
                <tr>
                  ...
                  <tr>
                      ...
                      <tr>
                        ...
                        <td width="192" height="28" align="left"><select name="mapFirstDSN"  id="mapFirstDSN"  dojoType="dijit.form.FilteringSelect" class="selectbox "trim="true" onChange="if (this.value != ''){enableFirstAttributes();loadData('getAttributeNames',this, setFirstDatasourceAttributes, 'insert')} else {disableFirstAttributes();loadData('getAttributeNames',this, setFirstDatasourceAttributes, 'insert')}" >
                        ...
                        <td colspan="4"><select name="mapWithSecondDSN"  id="mapWithSecondDSN"  dojoType="dijit.form.FilteringSelect" class="selectbox" "trim="true" onChange="if (this.value != ''){enableSecondAttributes();loadData('getAttributeNames',this, setSecondDatasourceAttributes, 'insert')} else {disableSecondAttributes();loadData('getAttributeNames',this, setSecondDatasourceAttributes, 'insert')}">
                            <option value=""><bean:message key="validation.msg.select" bundle="splchvalidation"/></option>
                            <logic:iterate id="datasourceName" name="allDatasources" >
                              <option value="<bean:write name="datasourceName" />">
                              <bean:write name="datasourceName" />
                      ...
                      <tr>
                        ...
                        <logic:notPresent name="ecoDatasourceListData">  
		                        ...
		                        <td width="192" height="28" align="left"><select name="mapFirstDSNAttr1"  id="mapFirstDSNAttr1"  dojoType="dijit.form.FilteringSelect" class="selectbox" store="firstAttrStore"  searchAttr="attr">
		                            <option value=""><bean:message key="validation.msg.select" bundle="splchvalidation"/></option>
		                          </select>
		                        </td>
		                        <td width="30" height="28">&nbsp;</td>
		                        ...
		                        <td ><select name="mapWithSecondDSNAttr1"  id="mapWithSecondDSNAttr1"  dojoType="dijit.form.FilteringSelect" class="selectbox" trim="true" store="secondAttrStore"  searchAttr="attr" >
		                           ...
		                           <td><a href="#"	onclick="javascript:addNewRow();return false;"><img src="<%=ServerUtils.getContextName(request)%>/images/portal/icon_plus_1.png"   /></a></td>
		                          </tr>
                          </logic:notPresent>
                          <logic:present name="ecoDatasourceListData">                       
                              <%
                              ...
                              %>                                 
			                        ...
			                        <td width="192" height="28" align="left"><select name='mapFirstDSNAttr<%=index+1%>'  id="mapFirstDSNAttr<%=index+1%>"  dojoType="dijit.form.FilteringSelect" class="selectbox" store="firstAttrStore"  searchAttr="attr">
			                            <option value=""><bean:message key="validation.msg.select" bundle="splchvalidation"/></option>
			                          </select>
			                        </td>
			                        <td width="30" height="28">&nbsp;</td>
			                        <td  align="right" class="bodytext" style="padding-right:5px;"><strong>			                           
			                         <td><select name="mapWithSecondDSNAttr<%=index+1%>"  id="mapWithSecondDSNAttr<%=index+1%>"  trim="true" dojoType="dijit.form.FilteringSelect" class="selectbox" store="secondAttrStore"  searchAttr="attr" >
			                            <option value=""><bean:message key="validation.msg.select" bundle="splchvalidation"/></option>
			                          </select></td>
			                          <%
			                          if(index==0) {
			                          ...
			                          <td><a href="#"	onclick="javascript:addNewRow();return false;"><img src="<%=ServerUtils.getContextName(request)%>/images/portal/icon_plus_1.png"  /></a></td>
			                          <% } else { %>
			                          <td><img src='<%=ServerUtils.getContextName(request)%>/images/portal/icon_dash_1.png'    style='cursor: hand;'  onclick='javascript:removeRow(this.parentNode.parentNode)'/></td>
			                          <% } %>
	...
	<tr>
      ...
      <tr class="barColor" align="right">
        <td colspan="7" class="barColor" align="right" width="900">
  ...
  <logic:present name="ecoDatasourceListData">
	...
	<tr>
      ...
      <tr class="barColor" align="right">
        <td colspan="4" class="barColor" align="right" width="900">
		<button dojoType="dijit.form.Button"  type="button"  onclick="window.location =  '<%=ServerUtils.getContextName(request)%>/adminMain.do'  ">
        <bean:message key="datasource.home" bundle="ds" />
        </button>
