 ...
 <table width="100%" cellspacing="0" cellpadding="0">
    ...
    <table width="100%" cellpadding="0" cellspacing="0"  align="left">
      ...
      <table width="100%" cellspacing="0" cellpadding="0" border = "0">
        ...
        <table valign = "center" width="65%" border="0">
        ...
        <td style = "padding-top:8px" align = "right" width = "25%">
					<strong><bean:message key="datasource.rssFeedUrl" bundle="ds" /><label class="error">*</label>:</strong> 
		  ...
		  <tr>
			<td width = "50%" style = "padding-left:6px;padding-top:3px;">
        ...
        <tr>
          ...
          <td align = "right" style = "pedding-left : 0px;">
		  <textarea  id="datasourceDesc" 
                            name="datasourceDesc" dojoType="dijit.form.SimpleTextarea" rows="5" cols="30" style="width:195px"><logic:present name="ecoDatasourceListData"><bean:write name="ecoDatasourceListData" property="datasourceDesc" /></logic:present></textarea>
          </td>
       ...
       <tr>
        ...
        <td style = "padding-top:20px;padding-left:67px;padding-right:30px;" colspan="8">
