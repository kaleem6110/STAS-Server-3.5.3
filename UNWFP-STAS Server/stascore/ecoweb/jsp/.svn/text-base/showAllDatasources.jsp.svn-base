           ...
           <logic:iterate name="ecoDatasourceList" scope="request" id="ecoDatasourceDtls" type="com.enterprisehorizons.magma.ecoweb.bean.NewEcoDataSourceBean" >
               ...
               <td class="textnormal12" align="center"> 
                            &nbsp;
                                ...
                                <input type="radio" name="datasource" id="<bean:write name="ecoDatasourceDtls" property="id"/>" value="<bean:write name="ecoDatasourceDtls" property="id"/>" onclick="enableBtn(this, '<bean:write name="ecoDatasourceDtls" property="datasourceTypeId" />');"/>
			   ...
			   <% 
					if(datasourceDescLabel !=null && datasourceDescLabel.length() > 100){
						...
						out.println(datasourceDescLabel);
					}
  ...
  <table width="101.2%" border=0 >
    ...
    <tr  align="right" class="barColor">
      <td  align="right" width="970"><button dojoType="dijit.form.Button"  type="button"  onclick="window.location =  '<%=ServerUtils.getContextName(request)%>/adminMain.do'  ">
        ...
        <button dojoType="dijit.form.Button"  type="button"  onclick="return isAnyRowSelected('<bean:message key="datasource.record.update" bundle="ds"/>','update');" id="updateBtn">
        <bean:message key="datasource.update" bundle="ds" />
        </button>
        <button dojoType="dijit.form.Button"  type="button"  onclick="return isAnyRowSelected('<bean:message key="datasource.record.delete" bundle="ds"/>','delete');" id="deleteBtn">
