  ...
  dijit.byId(array[j]).setAttribute('disabled', false);
    ...
    function updateparams(formName){
        //alert("2");
            ...
            document.getElementById("datasourceTypeId").value = '6';        
            //alert(dijit.byId("excelName").value);
            //alert(document.getElementById("excelName").value);
    ...
    function enableDisableColumns(selectedObject){
            try{
             ...
             resetExcelValues('',false);
                ...
                if((selectedObject.name == 'excelLongitude' || selectedObject.name == 'excelLatitude') && (document.forms[0].excelLatitude.value != '' || document.forms[0].excelLongitude.value != '' ) ){
                    resetExcelValues("excelCoordinates,address,addCity,addCountry,addCounty,addState,addZipCode",true);

            }    if( selectedObject.name == 'excelCoordinates' && document.forms[0].excelCoordinates.value != ''){  
...
<table width="100%" border = "0" cellspacing="0" cellpadding="0">
    ...
    <tr>
                    <td width ="20%" style="padding-right:9px;" align="right">
      ...
      <tr>
        ...
        <td  height="28" align="right" class="bodytext" style="padding-right:10px;" valign="center"><strong>
...
} else{resetExcelValues('',true);dijit.byId('selectFile').setAttribute('disabled',  false);}" store="filePathStore"     searchAttr="filePath" >
          ...
          <button dojoType="dijit.form.Button" id="selectFile" type="button" onClick="showMultiFileDialog('<bean:message key="datasource.check.excel.select" bundle="ds"/>','Excel Files:*.xls')")" >
          <bean:message key="datasource.addNewFile" bundle="ds" />
          </button>         
            </td>
            <td>&nbsp;</td>
      ...
      <tr>
        ...
        <td  height="28" align="left"><select id="excelLongitude" 
                            dojoType="dijit.form.FilteringSelect"  name="excelLongitude"    autoComplete="false"     invalidMessage="The value entered is not valid" onChange="enableDisableColumns(this);resetAddressFields(this);" store="columnStore" searchAttr="label">
          </select>
        ...
        <td colspan="4"><select id="excelLatitude" 
                            dojoType="dijit.form.FilteringSelect"  name="excelLatitude"    autoComplete="false"     invalidMessage="The value entered is not valid" onChange="enableDisableColumns(this);resetAddressFields(this);" store="columnStore" searchAttr="label">
          </select>
      ...
      <tr>
       <td  height="28" align="right" class="bodytext" style="padding-right:10px;"><strong>
        ...
        <td  height="28" align="left"><select id="excelCoordinates" 
                            dojoType="dijit.form.FilteringSelect"  name="excelCoordinates"    autoComplete="false"     invalidMessage="The value entered is not valid" onChange="enableDisableColumns(this);resetAddressFields(this);" store="columnStore" searchAttr="label">
          </select>
  ...
  <script>
                dojo.addOnLoad(loadFormValues); 
                    function loadFormValues(){
                        ...
                        loadData('LoadFilePaths', '.xls', setFilePaths, 'insert');
...
<logic:present name="ecoDatasourceListData">
  <logic:notEqual name="modeType" value="insert">
    ...
    <tr>
      ...
      <tr class="barColor" align="right">
        <td colspan="4" class="barColor" align="right" width="950"><button dojoType="dijit.form.Button"  type="button"  onclick="window.location =  '<%=ServerUtils.getContextName(request)%>/adminMain.do'  ">
        <bean:message key="datasource.home" bundle="ds" />
        </button>
        <button dojoType="dijit.form.Button"  type="button" onClick="window.location = 'WizardHomeAction.do?operation=showAllDatasource&pageNo=1' "> <bean:message key="datasource.back" bundle="ds" /> </button>
          <button dojoType="dijit.form.Button" id="save" type="submit" onClick="return UpdateDS()"><bean:message key="datasource.save" bundle="ds" /> </button></td>
      </tr>
    </table>
  </logic:notEqual>
  <logic:equal name="modeType" value="insert">
    ...
    <tr>
      ...
      <tr class="barColor" align="right">
        ...
        <button dojoType="dijit.form.Button"  type="button"  onClick="window.location='WizardHomeAction.do?operation=configureDatasource'"><bean:message key="datasource.back" bundle="ds" /> </button>
          <button dojoType="dijit.form.Button" id="save" type="submit" onClick="return checkUniqueDS()" ><bean:message key="datasource.save" bundle="ds" /> </button></td>
      </tr>
    </table>
  </logic:equal>
  <script>
    ...
    function loadFormValues(){
        ...
        loadData('LoadFilePaths', '.xls', setFilePaths, 'update');
        //alert("1");
