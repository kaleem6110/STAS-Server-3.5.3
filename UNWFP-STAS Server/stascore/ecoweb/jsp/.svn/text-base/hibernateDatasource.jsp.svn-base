...
dijit.byId('hibernateName').setValue('');
  ...
  dijit.byId(array[j]).setAttribute('disabled', false);
			...
			if(dijit.byId('hibernateName').value  == ""){
  ...
  function UpdateDS(){
	  ...
	  if(!validateSplOnTxtBox(dijit.byId('datasourceDesc').attr('value'))){
		...
		if(dijit.byId('hibernateName').value  == "-- select --"){
				showEmptyDialog("<bean:message key="datasource.check.hibernate.model" bundle="ds"/>","<bean:message key="datasource.alert" bundle="ds" />");	
				return false;
		}
       // if((document.getElementById('result').innerHTML.indexOf('Not') == -1) && (document.getElementById('result').innerHTML != '<b></b>')){       
    ...
    function enableDisableColumns(selectedObject){
			try{
	         ...
	         resetByTableValue('',false);
				...
				if((selectedObject.name == 'hibernateLongitude' || selectedObject.name == 'hibernateLatitude') && (document.forms[0].hibernateLatitude.value != '' || document.forms[0].hibernateLongitude.value != '' ) ){
					resetByTableValue("hibernateCoordinates,address,addCity,addCountry,addCounty,addState,addZipCode",true);

            }    if( selectedObject.name == 'hibernateCoordinates' && document.forms[0].hibernateCoordinates.value != ''){	
    ...
    <table width="100%" cellpadding="0" cellspacing="0"  align="left">
      ...
      <table width="100%" cellspacing="0" cellpadding="0">
        ...
        <table width="900" cellspacing="0" cellpadding="0" border="0">
          <tr>
            <td height="28" align="right" class="bodytext" style="padding-right:10px;">
            ...
            <td  height="28"><table>
                <tr>
                  <td><logic:notPresent name="ecoDatasourceListData">
                      <input type="text"  id="datasourceName" name="datasourceName" class="medium" maxLength="45"
            ...
            <td height="28">&nbsp;</td>
            <td  align="right" class="bodytext" style="padding-right:15px;"><strong><bean:message key='datasource.desc' bundle='ds'/></strong></td>
          ...
          <tr>
            <td width="95" height="28"  align="right" style="padding-left:65px;"><strong>
            ...
            <td width="200" height="28" align="left" colspan="12"><!-- <select id="hibernateName" 
                            dojoType="dijit.form.FilteringSelect" name="hibernateName" autoComplete="false" invalidMessage="Invalid Model Name" onChange="if (this.value != '') {resetByTableValue(this);loadData('loadHibernateData',this, setHibernateColumns, 'insert'); dijit.byId('hibernateQuery').setAttribute('disabled', true);}else{resetByTableValue(this)};" value="<logic:present name="ecoDatasourceListData"><bean:write name="ecoDatasourceListData" property="hibernateName" /></logic:present>">
							<option value=""></option>
			   ...
			   <select id="hibernateName" 
                            dojoType="dijit.form.FilteringSelect" name="hibernateName" autoComplete="false" invalidMessage="The value entered is not valid" onChange="if (this.value != '') {resetByTableValue('',true);loadData('loadHibernateData',this, setHibernateColumns, 'insert'); }else{resetByTableValue('',true)}; enableDisable();" store="modelStore" searchAttr="model" value="<logic:present name="ecoDatasourceListData"><bean:write name="ecoDatasourceListData" property="hibernateName" /></logic:present>">
							<option value=""></option>
							<logic:present name="hibernateModels" scope="session">
          ...
          <tr>
          <td width="0" height="28" align="right" class="bodytext" style="padding-top:10px;padding-left:35px;padding-right:15px;"><strong>
              <bean:message bundle="ecoweb" key="ecomodel.datasources.frameset.database.label.dblongitude" />
              : </strong></td>
            <td width="192" style="padding-top:10px;" height="28" align="left"><select id="hibernateLongitude" 
                            dojoType="dijit.form.FilteringSelect"  name="hibernateLongitude"    autoComplete="false"     invalidMessage="The value entered is not valid" store="columnStore" searchAttr="column" onChange="enableDisableColumns(this);resetAddressFields(this);">
              </select>
            </td>
            <td width="30" height="28">&nbsp;</td>
            <td align="right" class="bodytext" style="padding-top:10px;padding-right:15px;"><strong>
              <bean:message bundle="ecoweb" key="ecomodel.datasources.frameset.database.label.dblatitude" />
              : </strong></td>
            <td colspan="4" style="padding-top:10px;"><select id="hibernateLatitude" 
                            dojoType="dijit.form.FilteringSelect"  name="hibernateLatitude"    autoComplete="false"     invalidMessage="The value entered is not valid" store="columnStore" searchAttr="column" onChange="enableDisableColumns(this);resetAddressFields(this);">
                <option value=""><bean:message key="admin.common.dropdown.select" bundle="admin" /></option>
              </select></td>
          </tr>
          <tr>
            <td width="0" height="28" align="right" class="bodytext" style="padding-top:10px;padding-left:35px;padding-right:15px;"><strong><bean:message key="datasource.coordinates" bundle="ds" /></strong></td>
            <td width="192" height="28" align="left" style="padding-top:10px;"><select id="hibernateCoordinates" 
                            dojoType="dijit.form.FilteringSelect"  name="hibernateCoordinates"    autoComplete="false"     invalidMessage="The value entered is not valid" store="columnStore" searchAttr="column" onChange="enableDisableColumns(this);resetAddressFields(this);">
              </select>
            </td>
            <td width="30" height="28">&nbsp;</td>
            <td  align="right" class="bodytext" style="padding-top:10px;padding-right:15px;"><strong>
              <bean:message bundle="ecoweb" key="ecomodel.datasources.frameset.database.label.dborder" />
              : </strong></td>
            <td colspan="4" style="padding-top:10px;"><select id="hibernateOrder" 
                            dojoType="dijit.form.FilteringSelect"  name="hibernateOrder"    autoComplete="false"     invalidMessage="The value entered is not valid" store="columnStore" searchAttr="column">
                <option value=""><bean:message key="admin.common.dropdown.select" bundle="admin" /></option>
              </select></td>
          </tr>
  ...
  <logic:notPresent name="ecoDatasourceListData">
	...
	<tr>
      ...
      <tr class="barColor" align="right">
        <td colspan="7" class="barColor" align="right" width="950">
		...
		<button dojoType="dijit.form.Button"  type="button" onClick="window.location='WizardHomeAction.do?operation=configureDatasource'"> <bean:message key='admin.common.back' bundle='admin'/> </button>
          <button dojoType="dijit.form.Button" id="save" type="submit" onClick="return checkUniqueDS()" > <bean:message key='admin.common.save' bundle='admin'/> </button></td>
      </tr>
    </table>
    <script>
  ...
  <logic:present name="ecoDatasourceListData">
    <logic:notEqual name="modeType" value="insert">
	  ...
	  <tr>
        ...
        <tr class="barColor" align="right">
          <td colspan="4" class="barColor" align="right" width="950">
		  <button dojoType="dijit.form.Button"  type="button"  onclick="window.location =  '<%=ServerUtils.getContextName(request)%>/adminMain.do'  ">
        <bean:message key="datasource.home" bundle="ds" />
        </button>
		  <button dojoType="dijit.form.Button"  type="button" onClick="window.location = 'WizardHomeAction.do?operation=showAllDatasource&pageNo=1' "> <bean:message key='admin.common.back' bundle='admin'/> </button>
            <button dojoType="dijit.form.Button" id="save" type="submit" onClick="return UpdateDS()" > 
	  ...
	  <tr>
        ...
        <bean:message key="datasource.home" bundle="ds" />
		  ...
		  <button dojoType="dijit.form.Button"  type="button" onClick="window.location='WizardHomeAction.do?operation=configureDatasource'"> <bean:message key="datasource.back" bundle="ds" /> </button>
            <button dojoType="dijit.form.Button" id="save" type="submit" onClick="return checkUniqueDS()" > 
            <bean:message key="datasource.save" bundle="ds" />
             </button>
             </td>
        </tr>
