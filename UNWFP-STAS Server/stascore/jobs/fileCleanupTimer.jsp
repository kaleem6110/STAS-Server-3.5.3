...
com.enterprisehorizons.magma.jobs.forms.FileCleanUpTimerForm,com.spacetimeinsight.db.scheduler.model.ServerEnvMaster,com.spacetimeinsight.db.model.util.DataModelsCache, com.spacetimeinsight.db.scheduler.model.*"%>
...
<html:form action="/fileCleanUpTimerAction.do?operation=onUpdateFileCleanTimer">
				...
				<tr>
					...
					<td style="padding-left:10px;align:left;" width="90px">
						<input type="text"  id="jobName" name="jobName"  class="medium1" style="height:1.7em;" maxlength="45"
							dojoType="dijit.form.ValidationTextBox" required="true" trim="true" ucfirst="true"  value="<bean:write name="fileCleanupTimerForm" property="jobName" />" />                             
					</td>
				</tr>     
				<tr>                                       
		...
		<tr>
			...
			<table cellpadding="10" cellspacing="" border="0" width="100%">
				<tr>
					...
					<td style="padding-left:10px;align:left;" width="90px">
						<textarea dojoType="dijit.form.SimpleTextarea" rows="5" cols="30" id="description" class="medium1" style="height:5.7em;" name="description"  ><bean:write name="fileCleanupTimerForm" property="description" /></textarea>
					</td>
				</tr>     
				<tr>                                       
					<td style="width:90px;" >&nbsp;</td>
...
<tr>
	...
	<table cellpadding="10" cellspacing="" border="0" width="300" >
				<tr>
					...
					<td height="27" align="left"  colspan="2" >
						<select  id="jobType" dojoType="dijit.form.FilteringSelect"name="jobType" autoComplete="false"onchange="javascript:statusChange();" value="<bean:write name="fileCleanupTimerForm" property="jobType" />">
					...
					<td align="center">
						...
						<tr>
							...
							<td style="padding-left:10px;align:left;width:100px;">
								<html:checkbox  name="fileCleanupTimerForm" property="commonJobFlag" onclick="checkBoxAlert(this);" disabled="<%=checkboxstatus%>"></html:checkbox>
							</td>                
						</tr>
						</table>  
						<%}%>										
                                                            ...
                                                            <table cellpadding="10" cellspacing="" border="0" width="100%">
                                                                <tr>
                                                                    ...
                                                                    <td style="align:left;" width="120px"  >
                                                                     <input type="text"  id="directory" name="directory" class="medium" style="height:1.7em;width=140px;" 
                                                    dojoType="dijit.form.ValidationTextBox" required="true" trim="true" ucfirst="true" value="<bean:write name="fileCleanupTimerForm" property="directory"/>" />   
                                                                    </td>
                                                                </tr>       
                                                            </table>
                                                    </td> 
...
dojoType="dijit.form.ValidationTextBox" required="true" trim="true" ucfirst="true" value="<bean:write name="fileCleanupTimerForm" property="selectedFileType"/>"   />  
                                                ...
                                                <tr>
                                                    <td>
                                                            <table cellpadding="0" cellspacing="" border="0" width="100%">
                                                                <tr>
                                                                     <td height="27" align="left"  style="padding-left:5px;width:158px;" nowrap="nowrap" >
                  ...
                  <html:checkbox  name="fileCleanupTimerForm" property="includeSubdirectories" disabled="<%=readOnly%>"></html:checkbox>                
                                                    ...
                                                    <td align="center">
                                                            <table cellpadding="0" cellspacing="0" border="0">
                                                                <tr>
                                                                    <td height="27" align="right" style="width:110;padding-left:14px;">
                                                                    <label class="label"><bean:message key="jobs.fileCleanip.noOfDaysOld" bundle="jobs"/></label><b>:</b>
                                                                    </td>  
                                                                    <td style="padding-left:10px; align:left;" width="45px">  
                                                                        <input type="text"  id="noOfDaysOld" name="noOfDaysOld" style="height:1.7em;"
                                                                                        dojoType="dijit.form.NumberTextBox" constraints="{min:0,max:365,places:0}" invalidMessage="The value entered is invalid" value="<bean:write name="fileCleanupTimerForm" property="noOfDaysOld"/>" />
...
function loadFormValues(){
	...
	if(dijit.byId('startTimeType').value == START_JOB_AFTER_SERVER_START){
		...
		populateAbsoluteStartTypeValues('<bean:write name="fileCleanupTimerForm" property="cronTypeId" />', status);
			...
			dojo.byId('expression').value = '<bean:write name="fileCleanupTimerForm" property="expression" />';
