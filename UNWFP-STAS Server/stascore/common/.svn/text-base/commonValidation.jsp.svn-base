...
var MSG_AJAX_TXTBOX_SPL_CH = "<bean:message key="validation.msg.ajaxTxtBoxSplCh" bundle="splchvalidation"/>";
...
var AJAX_TXTBOX_SPL_CH  ="<bean:message key="validation.ajaxTxtBoxSplCh" bundle="splchvalidation"/>";
